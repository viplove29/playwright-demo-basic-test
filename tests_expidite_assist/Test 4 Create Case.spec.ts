...
test(
  "Test 4: Create Case for Expidite Assit",
  {
    tag: "@smoke",
  },
  async ({ page }) => {
    ...
    const submitCase: Locator = page.getByRole("button", {
      name: "Submit Case",
    });
